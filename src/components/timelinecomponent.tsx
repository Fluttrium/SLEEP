...
/>
    ...
    },
    {
      ...
      content: (
        <div>
             <Title text="Получаете результаты" size="2xl" className="text-neutral-800 dark:text-neutral-200 mb-2" />
             <Title text="✅ Получаете вероятные результаты сна
    ...
    },
    {
      ...
      content: (
        <div>
             <Title text="Диагностика" size="2xl" className="text-neutral-800 dark:text-neutral-200 mb-2" />
             <Title text="✅ Записываетесь на диагностику, консультации
          " size="md" className="text-neutral-800 dark:text-neutral-200 mb-8" />
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/iStock-896820002-1.jpg"
    ...
    },
    {
      ...
      content: (
        <div>
            <Title text="Прием у врача или онлайн" size="2xl" className="text-neutral-800 dark:text-neutral-200 mb-2" />
          <div className="mb-8">
          ...
          <Title text="✅ Пожизненное сопровождение. Мы никогда вас не подведем" size="md" className="text-neutral-800 dark:text-neutral-200 mb-8" />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/iStock-896820002-1.jpg"
